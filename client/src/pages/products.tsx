...
export default function Products() {
  ...
  return (
    <div className="space-y-3 sm:space-y-6">
      ...
      <header className="mb-3 sm:mb-6">
        <h1 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-1 sm:mb-2">Our Products</h1>
        <p className="text-sm sm:text-base text-gray-600">Discover our carefully curated collection</p>
      </header>

      {!products || products.length === 0 ? (
        <div className="text-center py-8 sm:py-12">
          <div className="text-gray-500 text-base sm:text-lg">No products available at the moment</div>
          <p className="text-gray-400 mt-2 text-sm sm:text-base">Please check back later</p>
        </div>
      ) : (
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-6">
